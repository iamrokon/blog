    ...
    <FrontendLayout>
        ...
        <div class="container max-w-6xl px-5 mx-auto my-10 xl:my-8 md:px-2">
            ...
            <div
                ...
                <p class="text-base text-white/60">{{ job_count }} Results Found</p>
                </div>
                <!-- /Section Header -->
                <!-- Job Listings -->
                <div>
                    ...
                    <div v-for="job in jobs.data" :key="job.id"
                        ...
                        <div
                            ...
                            <h6
                                ...
                                <Link :href="route('frontend.job_details', job.id)">{{ job.title }}</Link>
                            </h6>
                ...
                <template v-else>
                    <h4>No Blogs Posted yet. Come back later.</h4>
                </template>
                </div>
                <!-- /Job Listings -->
            </div>
